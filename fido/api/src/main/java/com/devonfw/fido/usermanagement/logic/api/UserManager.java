...
package com.devonfw.fido.usermanagement.logic.api;
...
public interface UserManager extends UserDetailsService {
   ...
   */
  UserCto createUser(UserCto userEntity);
   ...
   * @param userEntity userEntity
   */
  void updateUser(UserCto userEntity);
