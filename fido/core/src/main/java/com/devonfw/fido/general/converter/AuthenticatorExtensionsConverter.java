...
public class AuthenticatorExtensionsConverter
    implements AttributeConverter<Map<String, RegistrationExtensionAuthenticatorOutput>, String> {
  ...
  public String convertToDatabaseColumn(Map<String, RegistrationExtensionAuthenticatorOutput> attribute) {
    ...
    return Base64UrlUtil.encodeToString(this.cborConverter.writeValueAsBytes(attribute));
  }

  @Override
  public Map<String, RegistrationExtensionAuthenticatorOutput> convertToEntityAttribute(String dbData) {

    return this.cborConverter.readValue(Base64UrlUtil.decode(dbData),
