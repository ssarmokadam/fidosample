...
import com.devonfw.fido.general.service.impl.filter.ServerAuthenticatorResponse;
import com.devonfw.fido.general.service.impl.filter.ServerPublicKeyCredential;
...
public class BeanAssertUtil {
  ...
  public static <T extends ServerAuthenticatorResponse> void validate(
      ServerPublicKeyCredential<T> serverPublicKeyCredential) {
