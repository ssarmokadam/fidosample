...
public class ServerPublicKeyCredentialCreationOptionsResponse extends ServerResponseBase {
  ...
  public ServerPublicKeyCredentialCreationOptionsResponse(PublicKeyCredentialRpEntity rp,
      ServerPublicKeyCredentialUserEntity user, String challenge, List<PublicKeyCredentialParameters> pubKeyCredParams,
      Long timeout, List<ServerPublicKeyCredentialDescriptor> excludeCredentials,
