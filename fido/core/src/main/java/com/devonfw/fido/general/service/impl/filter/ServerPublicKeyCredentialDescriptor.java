...
public class ServerPublicKeyCredentialDescriptor implements Serializable {
  ...
  public ServerPublicKeyCredentialDescriptor(PublicKeyCredentialType type, String id,
  ...
  public boolean equals(Object o) {
    ...
    return this.type == that.type && Objects.equals(this.id, that.id)
        && Objects.equals(this.transports, that.transports);
  }

  @Override
  public int hashCode() {

    return Objects.hash(this.type, this.id, this.transports);
  }
}
