...
class ServerEndpointFilterUtil {
  ...
  void writeResponse(HttpServletResponse httpServletResponse, ServerResponse response) throws IOException {
    ...
    String responseText = this.jsonConverter.writeValueAsString(response);
  ...
  void writeErrorResponse(HttpServletResponse httpServletResponse, RuntimeException e) throws IOException {
    ...
    String errorResponseText = this.jsonConverter.writeValueAsString(errorResponse);
    httpServletResponse.setContentType("application/json");
  ...
  Challenge encodeUsername(Challenge challenge, String username) {
    ...
    byte[] bytes = this.cborConverter.writeValueAsBytes(envelope);
  ...
  String decodeUsername(Challenge challenge) {
    ...
    try {
      UsernameEncodedChallengeEnvelope envelope = this.cborConverter.readValue(challenge.getValue(),
          UsernameEncodedChallengeEnvelope.class);
  ...
  UserVerificationRequirement decodeUserVerification(Challenge challenge) {
    ...
    try {
      UserVerificationEncodedChallengeEnvelope envelope = this.cborConverter.readValue(challenge.getValue(),
          UserVerificationEncodedChallengeEnvelope.class);
